            ...
            Timer.after(1.5, function()
                ...
                :finish(function()
                    ...
                    if self.playerPokemon.currentExp > self.playerPokemon.expToLevel then
                        ...
                        -- record the original stat and the increase of stat of the pokemon
                        ...
                        local HPUp, attackUp, defenseUp, speedUp = self.playerPokemon:levelUp()
