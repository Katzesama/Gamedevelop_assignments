...
public class LevelGenerator : MonoBehaviour {
	...
	// we use to keep track of the number of holes
	private int holes = 0;
	private bool generateHole;
	...
	void Start () {
		...
		for (int z = 0; z < mazeSize; z++) {
			for (int x = 0; x < mazeSize; x++) {
				...
				} else if (Random.value < 0.02 && holes < 4){

					// flag so this postition's floor won't be generated
					generateHole = true;
					holes += 1;
				}
